/*
   Every time a player passes through a gap between the pipe player
   will score points. The ScoreZone is an invisible object that is
   positioned over the gaps.
 */
interface Props {
  scene: Phaser.Scene;
  x: number;
